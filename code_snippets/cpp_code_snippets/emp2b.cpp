// emp2b.cpp: Introduces vector::emplace to avoid copying Employee objects
#include <iomanip>
#include <iostream>
#include <string>
#include <vector>
...
int main() {
    ...
    // Add some employees
    emps.emplace_back(7902,"Smith","Gerald","1234 First Avenue","Chicago","IL","23456",89012.34);
    emps.emplace_back(7499,"Allen","Bud","5678 Second Street","Lincoln","NB","45678",78901.23);
    emps.emplace_back(7521,"Ward","Robert","90123 Third Blvd","San Luis Obispo","CA","90123",90123.45);
